...
import selenium.b30.TestBase;

import static org.junit.jupiter.api.Assertions.assertEquals;

public class L5task10Firefox {
    ...
    public void l5task10() {
        ...
        WebDriverWait wait = new WebDriverWait(driverF, 10);
        driverF.get("http://localhost/litecart/");
        wait.until(ExpectedConditions.titleIs("Online Store | My Store"));

        WebElement product = driverF.findElement(By.cssSelector("div[id = box-campaigns] li.product:nth-child(1)")); // первый товар блока Campaigns
        ...
        String productLinkP = driverF.getCurrentUrl();//получаем ссылку на текущую страницу
        String productNameP = driverF.findElement(By.cssSelector("#box-product .title")).getAttribute("textContent");// название товара
        WebElement regularPriceP = driverF.findElement(By.cssSelector("#box-product .regular-price"));//элемент с обычной ценой товара
        WebElement campaignPriceP = driverF.findElement(By.cssSelector("#box-product .campaign-price"));//элемент с акционной ценой товара
